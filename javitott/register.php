...
<body>
	...
	if (isset($_POST['registration'])) {
		...
		if (isset($_POST["newpassword"])) {
			...
			$pw = mysqli_real_escape_string($kapcsolat,$_POST["newpassword"]);
			$szszam = mysqli_real_escape_string($kapcsolat,$_POST["newszszam"]);
			$newusername = mysqli_real_escape_string($kapcsolat,$_POST["newusername"]);
			
			$hashedpw = password_hash($pw , PASSWORD_DEFAULT);
		}

		$sql = "INSERT INTO users (username,szszam,password)
			VALUES('$newusername','$szszam','$hashedpw')";
